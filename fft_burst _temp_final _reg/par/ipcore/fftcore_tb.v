...
initial
   begin
     ...
     fftpts_array[2]=1024;
     fftpts_array[3]=1024;
     data_rf = $fopen("fftcore_real_input.txt","r");
     data_if = $fopen("fftcore_imag_input.txt","r");
     fft_rf = $fopen("fftcore_real_output_ver.txt");
     fft_if =$fopen("fftcore_imag_output_ver.txt");
     expf = $fopen("fftcore_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
